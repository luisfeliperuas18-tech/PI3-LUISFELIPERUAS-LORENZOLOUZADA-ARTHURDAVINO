...
Ampliação do processamento do corpus com a utilização do pacote `SnowballC`.
...
Permite reduzir variações de uma mesma palavra e destacar termos mais representativos do conteúdo analisado.
